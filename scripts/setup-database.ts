...
// Run with: node --loader ts-node/esm scripts/setup-database.ts

import { createClient } from '@supabase/supabase-js';

const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://lmmpvvtkzlnblvlflhpk.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxtbXB2dnRremxuYmx2bGZsaHBrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczODk4MjUyMCwiZXhwIjoyMDU0NTU4NTIwfQ.lF0kJ_TQD2zTDAqpAotdJKb2WG4i0x_QspvTaFH7gAg';
